...
!(function (t, e) {
  ...
  var Ge = rt(function (t) {
    ...
    return (
      Be(e, "uk-" + t),
      (t = Ye(e, "content", ":before").replace(/^["'](.*)["']$/, "$1")),
      Se(e),
      t
    );
  });
  function Xe(t) {
    return ht
      ? Ge(t)
      : Ue(document.documentElement).getPropertyValue("--uk-" + t);
  }
  ...
  function sn(t) {
    t = _(t)
      ...
      : { height: hn(t), width: ln(t), top: 0, left: 0 };
    return {
      height: t.height,
      width: t.width,
      top: t.top,
  ...
  function an(n, i) {
    ...
    X(qe(n, ["left", "top"]), function (t, e) {
      return qe(
        n,
        e,
        i[e] - r[e] + L("absolute" === a && "auto" === t ? un(n)[e] : t),
      );
    });
  }
  function un(t) {
    ...
    return (
      _(a) &&
        ((n -= (r = an(a)).top + L(qe(a, "borderTopWidth"))),
        (i -= r.left + L(qe(a, "borderLeftWidth")))),
      { top: n - L(qe(t, "marginTop")), left: i - L(qe(t, "marginLeft")) }
    );
  }
  function cn(t) {
    var e = [0, 0];
  ...
  function pn(t) {
    for (var e in on)
      for (var n in on[e]) if (on[e][n] === t) return on[e][1 - n];
    return t;
  }
  function mn(t, e, n) {
    return (
  ...
  function wn(t) {
    void 0 === t && (t = 1),
      yn(vn.reads),
      yn(vn.writes.splice(0)),
      (vn.scheduled = !1),
      (vn.reads.length || vn.writes.length) && xn(t + 1);
  }
  var bn = 4;
  function xn(t) {
    vn.scheduled ||
  ...
  function Cn(e, n, i) {
    var t,
      ...
      o = {};
    if (
      ((n = k(n) ? n.options : n).extends && (e = Cn(e, n.extends, i)),
      n.mixins)
    )
  ...
  function Nn(t) {
    Bn(t) && Hn(t, { func: "mute", method: "setVolume", value: 0 }),
      Dn(t) && (t.muted = !0);
  }
  function zn(t) {
    return Dn(t) || Bn(t);
  ...
  (ni.util = ei),
    ...
    ((ai = ni).prototype._init = function (t) {
      ((t = t || {}).data = (function (t, e) {
        ...
        if (
          ...
          for (var o in n)
            O(n[o]) ? delete n[o] : (n[o] = r[o] ? gi(r[o], n[o]) : n[o]);
        return n;
    ...
    (ai.prototype._initProps = function (t) {
      for (var e in (t = t || pi(this.$options, this.$name)))
    ...
    (ci.component = function (s, t) {
      var e = d(s);
      if (((s = f(e)), !t))
        return I(li[s]) && (li[s] = ci.extend(li[s])), li[s];
      ci[s] = function (t, n) {
                  ...
                  return (
                    ...
                    bi(o)(e._wrapper, n).then(function () {
                      ...
                      yi(i, !n),
                        ...
                        Te(i),
                        n &&
                          (Wn((t = Ne(o.$props.toggle, e))) ||
                            Rn(t, { offset: o.offset }));
                    })
                  );
                yi(i, !n);
              });
  ...
  var ki = {
      ...
      data: {
        ...
        duration: 150,
        hideProps: Y({ opacity: 0 }, wi.data.hideProps),
      },
      events: [
        {
          name: "click",
      ...
      events: [
        ...
        },
        {
          ...
          handler: function (t) {
            t = t.target;
            this.$el === t
              ? ((Ii = this.isActive() ? null : Ii), this.tracker.cancel())
              : (Ii =
                  null === Ii && Bt(t, this.$el) && this.isToggled()
                    ? this
                    : Ii);
          },
        },
            ...
            },
            {
              write: function () {
                ...
                this.elements.forEach(function (t) {
                  ...
                  e &&
                    (n.forceHeight ||
                      Math.round(e + fn(t, "height", "content-box")) >=
                        t.offsetHeight) &&
                    qe(t, "height", e);
                });
              },
        ...
        read: function (t) {
          ...
          return (
            this.expand
              ? (n =
                  hn(window) -
                    (sn(document.documentElement).height -
                      sn(this.$el).height) -
                    i || "")
              : ((n = "calc(100vh"),
                this.offsetTop &&
                  (n +=
                    0 < (t = an(this.$el).top) && t < hn(window) / 2
                      ? " - " + t + "px"
                      : ""),
                !0 === this.offsetBottom
                  ...
                  : D(this.offsetBottom)
                    ...
                    : this.offsetBottom && u(this.offsetBottom, "px")
                      ...
                      : N(this.offsetBottom) &&
                        (n +=
                          " - " +
                          sn(Lt(this.offsetBottom, this.$el)).height +
                          "px"),
                (n += (i ? " - " + i + "px" : "") + ")")),
            { minHeight: n, prev: e }
          );
    ...
    Wi = {
      ...
      update: {
        ...
        write: function () {
          var t, e;
          (t = this.svgEl),
            (e = Ui(t)) && t.style.setProperty("--uk-animation-stroke", e);
        },
        type: ["resize"],
      },
      methods: {
                ...
                e &&
                  ...
                  (t =
                    (function (t, e) {
                      if (!qi[t]) {
                        var n;
                        for (qi[t] = {}, Ri.lastIndex = 0; (n = Ri.exec(t)); )
                          qi[t][n[3]] =
      ...
      load: function (t) {
        ...
        t.some(function (t) {
          ...
          ((this._data.image = ve(
            ...
            function (t) {
              return (
                or(e.$el, dr(t), t.srcset, t.sizes), (fr[e.cacheKey] = dr(t)), t
              );
            },
            function (t) {
      ...
      events: [
        ...
        },
        {
          ...
          handler: function (t, e) {
            t.defaultPrevented ||
              (t.preventDefault(),
              (this.target = e.$el),
              this.isToggled() === w(vr, this) && this.toggle());
          },
        },
        {
          name: "beforeshow",
        ...
        },
        {
          ...
          handler: function () {
            ...
            ln(window) > t.clientWidth &&
              this.overlay &&
              qe(document.body, "overflowY", "scroll"),
              this.stack &&
                qe(this.$el, "zIndex", L(qe(this.$el, "zIndex")) + vr.length),
              Be(t, this.clsPage),
              this.bgClose &&
                te(
                  this.$el,
        ...
        },
        {
          ...
          self: !0,
          handler: function () {
            Tt(this.$el) || ot(this.$el, "tabindex", "0"),
      ...
      return new le(function (n, i) {
        return te(r, "show hide", function () {
          ...
          var t = te(
              ...
              "transitionstart",
              function () {
                te(s, "transitionend transitioncancel", n, { self: !0 }),
                  clearTimeout(e);
              },
              { self: !0 },
            ),
  ...
  function yr(t, e, n) {
    var i = t.current,
      ...
      t = (n && n.target) || i,
      i = e.indexOf(t);
    r === $r.LEFT && 0 < i && (n && n.hide(!1), e[i - 1].focus()),
      r === $r.RIGHT && i < e.length - 1 && (n && n.hide(!1), e[i + 1].focus()),
      r === $r.TAB && (t.focus(), n && n.hide(!1));
  }
  function kr(t) {
      ...
      update: [
        {
          read: function (t) {
            ...
            this.elements.forEach(function (t) {
              t[Ir] || (t[Ir] = { cls: ut(t, "uk-scrollspy-class") || e.cls }),
            ...
            return (
              e === r
                ...
                : (this.targets.every(function (t, e) {
                    if (an(t).top - an(Yn(i)).top - n.offset <= 0)
                      return (o = e), !0;
                  }),
      ...
      update: [
        {
          read: function (t, e) {
            ...
            return (
              (this.top =
                Math.max(L(Er("top", this)), this.topOffset) - this.offset),
                ...
                (this.showOnUp &&
                  ...
                  : this.isFixed
                    ...
                    : this.animation
                      ? (rn.cancel(this.$el),
                        this.show(),
                        rn.in(this.$el, this.animation).catch(Q))
                      : this.show()));
          },
          events: ["resize", "scroll"],
        },
  ...
  function Mr(t) {
    ...
    t &&
      t in Tr &&
      (st(e, n) ? Tr[t](e) : (t = Tr.getComponent(e, t)) && t.$destroy());
  }
  X(
    Object.freeze({
      __proto__: null,
        ...
        return (
          ...
          new le(function (r) {
            return requestAnimationFrame(function () {
              ...
              o !== e &&
                i.push(
                  Qe.start(s, { height: e }, a / 2 + n.length * u, "ease"),
                ),
                le.all(i).then(function () {
                  Oe(s, zr),
                    c === Br(s) &&
                      (qe(s, { height: "", alignContent: "" }),
                      qe(t, { opacity: "" }),
  ...
  function Br(t, e) {
    return (
      e && (t.dataset.transition = 1 + Br(t)), H(t.dataset.transition) || 0
    );
  }
  function Or(t) {
    return le.all(
        ...
        Transitioner: function (r, o, s, t) {
          ...
          return {
            ...
            translate: function (t) {
              ...
              qe(o, e[1]),
                qe(r, e[0]),
                Gr(o, "itemtranslatein", { percent: t, dir: s }),
                Gr(r, "itemtranslateout", { percent: 1 - t, dir: s });
            },
            percent: function () {
              return n(r || o, o, s);
            },
  ...
  Zi = {
    ...
    methods: {
      close: function (t) {
        ...
        var n = this;
        this.timer && clearTimeout(this.timer),
          t ? e(this.$el) : Qe.start(this.$el, this.startProps).then(e);
      },
    },
  };
  var Qr = [
    ...
    update: {
      read: function (t, e) {
        ...
        if ((e.has("scroll") || (n = !1), this.matchMedia)) {
          var i = n;
          return (
            (t = qn(this.target) / (this.viewport || 1)),
            (e = this.easing),
            {
  ...
  function eo(t, e, n) {
    var i = ro(t, e);
    return n
      ? i - ((t = t), sn(e).width / 2 - sn(t).width / 2)
      : Math.min(i, no(e));
  }
  function no(t) {
  ...
  function ro(t, e) {
    return (
      (t &&
        (un(t).left + (lt ? sn(t).width - sn(e).width : 0)) * (lt ? -1 : 1)) ||
      0
    );
  }
  function oo(n, i) {
        ...
        return {
          ...
          translate: function (r) {
            ...
            qe(
              l,
              "transform",
              qr(Z(t - t * r - d, -io(l), sn(l).width) * (lt ? -1 : 1), "px"),
            );
        ...
        if (!this.dragging && 1 < e) {
          ...
          t =
            this.dir < 0 || !this.slides[this.prevIndex]
              ...
              : this.prevIndex;
          (this.duration =
            Xr(this.avgWidth / this.velocity) *
            (sn(this.slides[t]).width / this.avgWidth)),
            this.reorder();
        }
      },
      itemshow: function () {
      ...
      reorder: function () {
        ...
        if (this.finite) qe(this.slides, "order", "");
          ...
          if (
            ...
            for (
              var t = this.slides[i],
                e = sn(this.list).width / 2 - sn(t).width / 2,
                r = 0;
              0 < e;
          ...
          return (
            this.minHeight && (t = Math.max(this.minHeight, t)),
            {
              height:
                ...
                fn(this.list, "height", "content-box"),
            }
          );
        },
        write: function (t) {
    ...
    Pi = {
      ...
      computed: {
        ...
        handles: {
          ...
          watch: function (t, e) {
            qe(e, { touchAction: "", userSelect: "" }),
              qe(t, { touchAction: pt ? "none" : "", userSelect: "none" });
          },
          immediate: !0,
        },
      },
      ...
      upload: function (t) {
        ...
        if (t.length) {
          ...
          for (var e = 0; e < t.length; e++) {
            ...
            if (this.allow && !lo(this.allow, t[e].name))
              return void this.fail(
                this.msgInvalidName.replace("%s", this.allow),
              );
            if (this.mime && !lo(this.mime, t[e].type))
              return void this.fail(
